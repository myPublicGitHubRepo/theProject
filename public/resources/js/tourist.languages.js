...
var touristLanguages = (function () {
    ...
    function _addSavedLanguages(){
        ...
        if(languages.length < 1){
            languages = _getFromLocalStorage(localStorageKey);
            //new tourist
            if(languages == null){
                languages = [];
            }
        ...
        if(languages.length > 0){
            ...
            $.each(languages, function(index, value){
                ...
                _displaySelectedLanguage(value.code, value.skill);
            });
        }else{
    ...
    function _displaySelectedLanguage(code, skill){
        //checkbox
     ...
     */
    function _clearLanguageStorage(){
        console.log('clear');
    ...
    function _submitLanguages(){
        ...
        _saveToLocalStorage(localStorageKey, languages);
