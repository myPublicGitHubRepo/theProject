...
var connectionHelper = (function () {
    ...
    */
    ...
    function sendMessageSCTP(message) {
        if(showLogs) console.log('sending SCTP message, channel: ' + connectionHelper.connection.channel);
        connectionHelper.connection.send(message);
    }
    /**
    ...
    function sendMessageWebsocket(message) {
        if(showLogs) console.log("sending: message using websocket custom event: " + connectionHelper.connection.socketCustomEvent);
        connectionHelper.websocket.emit(connectionHelper.connection.socketCustomEvent, {
            sender: connectionHelper.connection.userid,
    ...
    return {
        ...
        websocket: websocket,
        conEstabTimeout: conEstabTimeout,
        conEstabTimer: conEstabTimer,
        username: username,
        peername: peername,
        ...
        sendUseWebsocketConnection: sendUseWebsocketConnection,
        sendUsername: sendUsername,
        sendFirstPosition: sendFirstPosition,
        sendTouristRequestsGuide: sendTouristRequestsGuide,
        sendGuideAcceptsRequest: sendGuideAcceptsRequest,
        sendGuideDeclinesRequest: sendGuideDeclinesRequest,
        sendTouristRevokesRequest: sendTouristRevokesRequest,
        sendCloseConnection: sendCloseConnection,
        sendMapData: sendMapData,
        supportsOnlyWebsocket: supportsOnlyWebsocket,
        noMediaSupported: noMediaSupported,
        supportsAudioOnly: supportsAudioOnly,
        supportsVideoOnly: supportsVideoOnly,
        supportsAudioVideo: supportsAudioVideo,
        stopStreams: stopStreams,
        sendHideVideo: sendHideVideo,
        sendShowVideo: sendShowVideo,
        sendImage: sendImage
    };
